...
export const serviceSeedDatabase = async () => {
    try {
      ...
      service1.service_name = "1.Personalized tattoo",
      ...
      service2.service_name = "2.Tattoos from the catalog",
      ...
      service3.service_name = "3.Restoration and rejuvenation work",
      ...
      service4.service_name = "4.Placement of piercings and dilators",
      ...
      service5.service_name = "5.Sales of piercings and other items",
